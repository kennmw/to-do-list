        ...
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          ...
          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
              ...
              <li><a class="nav-link scrollto" href="#">Add &#x2795;</a></li>
            </ul>
      ...
      <div class="row justify-content-center">
        <div class="col-xl-8">
          ...
          <form action="login_pro.php" method="post">
            ...
            <input type="text" class="form-control" name="uname" id="subject" placeholder="Username" required>
            <input type="password" class="form-control" name="pword" id="subject" placeholder="Password" required>
            <div class="text-center"><button type="submit">Login&#x2794;</button></div>
          </form>
          <div class="text-center"><a href="http://localhost/timo/reg">Register&#x2794;</a></div>
